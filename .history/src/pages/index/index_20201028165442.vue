<template>
  <view class="container index">
    ...
    <!---->
    <uni-notice-bar @getmore="getMore" :showGetMore="true" showIcon="true" scrollable="true" single="true" text="[多行] 这是 NoticeBar 通告栏，这是 NoticeBar 通告栏，这是 NoticeBar 通告栏这是 NoticeBar 通告栏，这是 NoticeBar 通告栏，这是 NoticeBar 通告栏"></uni-notice-bar>
