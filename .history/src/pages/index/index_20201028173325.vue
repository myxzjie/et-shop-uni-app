<template>
  <view class="container index">
    ...
    <!---->
    <uni-notice-bar @getmore="getMore" :showGetMore="true" showIcon="true" scrollable="true" single="true" :speed="50" text="[多行] 这是 NoticeBar 通告栏，这是 NoticeBar 通告栏，这是 NoticeBar 通告栏这是 NoticeBar 通告栏，这是 NoticeBar 通告栏，这是 NoticeBar 通告栏"></uni-notice-bar>

     <view class="news acea-row row-left">
      <view class="pictrue">
        <image :src="noticeImage" show-menu-by-longpress></image>
      </view>
...
export default {
  components: { uniSearchBar,uniNoticeBar },
  data() {
    return {
      tabInde: 0,
      tabbar: [
