<template>
  <view class="container index">
    ...
    <!---->
    <uni-notice-bar @getmore="getMore" :showGetMore="true" moreText="更多" showIcon="true" scrollable="true" single="true" text="[多行] 这是 NoticeBar 通告栏，这是 NoticeBar 通告栏，这是 NoticeBar 通告栏这是 NoticeBar 通告栏，这是 NoticeBar 通告栏，这是 NoticeBar 通告栏"></uni-notice-bar>

     <view class="news acea-row row-between-wrapper">
      <view class="pictrue">
        <img :src="noticeImage" show-menu-by-longpress>
      </view>
