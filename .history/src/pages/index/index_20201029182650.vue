<template>
  <!-- <view class="uni-flex tui" style="flex-direction: column;justify-content: space-between;position: relative;">
		...
		<view class="uni-flex tab-bar" style="height: 98upx; border-top:1px solid #DDDDDD;" >
  ...
  <view>
    <view class="river">
      ...
      <goods-class v-show="active === 1" />
      <news-list v-show="active === 2" />
      <shopping-cart v-show="active === 3" />
      <user v-show="active === 4" />
    </view>
    <!---->
    <view class="tab-bar">
      <view class="line" />
      <view class="acea-row row-middle">
        <view
          ...
          @click="onSwitchTab(index,item)"
        >
          <view
            class="iconfont"
            :class="(index == active ? item.icon2 : item.icon1 )"
          />
          <view>{{ item.name }}</view>
        </view>
      </view>
      ...
      tabBar: [
        {
          name: '首页',
          icon1: 'icon-tab-home',
          icon2: 'icon-tab-home-check',
          url: '/pages/home/index'
        },
        {
          name: '分类',
          icon1: 'icon-tab-cate',
          icon2: 'icon-tab-cate-check',
          url: '/pages/cate/index'
        },
        {
          name: '资讯',
          icon1: 'icon-tab-information',
          icon2: 'icon-tab-information-check',
          url: '/pages/shop/news/NewsList/main'
        },
        {
          name: '购物车',
          icon1: 'icon-tab-cart',
          icon2: 'icon-tab-cart-check',
          url: '/pages/shop/ShoppingCart/main'
        },
        {
          name: '我的',
          icon1: 'icon-tab-me',
          icon2: 'icon-tab-me-check',
